...
import "./priority-content.css";
import PriorityIcon from "../Priority-Icon/PriorityIcon";
import { sortTickets } from "../../utils/functions";

export default function PriorityContent({ data, ordering, grouping }) {
	const np_tickets = data ? data.tickets?.filter((details) => details.priority === 0) : [];
	const urgent_tickets = data ? data.tickets?.filter((details) => details.priority === 4) : [];
	const high_tickets = data ? data.tickets?.filter((details) => details.priority === 3) : [];
	const medium_tickets = data ? data.tickets?.filter((details) => details.priority === 2) : [];
	const low_tickets = data ? data.tickets?.filter((details) => details.priority === 1) : [];
	return (
			...
			<div className="content-block">
				<div className="content-header">
					<div className="content-header-left">
						...
						<text style={{ opacity: 0.5 }}>{np_tickets.length}</text>
					</div>
					<div className="content-header-right">
						...
						<div className="content-header-dots">
							<svg
								width="16"
								height="16"
								viewBox="0 0 16 16"
				...
				<div className="content-body">
                    {data && sortTickets(np_tickets, ordering).map((details) => (
			...
			<div className="content-block">
				<div className="content-header">
					<div className="content-header-left">
						...
						<text>Urgent</text>
						<text style={{ opacity: 0.5 }}>{urgent_tickets.length}</text>
					</div>
					<div className="content-header-right">
						<div className="content-header-add">
							<svg
				...
				<div className="content-body">
                    {data && sortTickets(urgent_tickets, ordering).map((details) => (
                        <Card details={details} grouping={grouping} />
                    ))}
                </div>
			</div>
			<div className="content-block">
				<div className="content-header">
					<div className="content-header-left">
						...
						<text>High</text>
						<text style={{ opacity: 0.5 }}>{high_tickets.length}</text>
					</div>
					<div className="content-header-right">
						<div className="content-header-add">
							<svg
				...
				<div className="content-body">
                    {data && sortTickets(high_tickets, ordering).map((details) => (
                        <Card details={details} grouping={grouping} />
                    ))}
                </div>
			</div>
			<div className="content-block">
				<div className="content-header">
					<div className="content-header-left">
						...
						<text>Medium</text>
						<text style={{ opacity: 0.5 }}>{medium_tickets.length}</text>
					</div>
					<div className="content-header-right">
						<div className="content-header-add">
							<svg
				...
				<div className="content-body">
                    {data && sortTickets(medium_tickets, ordering).map((details) => (
                        <Card details={details} grouping={grouping} />
                    ))}
                </div>
			</div>
			<div className="content-block">
				<div className="content-header">
					<div className="content-header-left">
						...
						<text>Low</text>
						<text style={{ opacity: 0.5 }}>{low_tickets.length}</text>
					</div>
					<div className="content-header-right">
						<div className="content-header-add">
							<svg
				...
				<div className="content-body">
                    {data && sortTickets(low_tickets, ordering).map((details) => (
                        <Card details={details} grouping={grouping} />
                    ))}
                </div>
			</div>
